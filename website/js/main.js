...
function setupDownloadButton() {
    ...
    // Google Drive direct download link - Fixed version with all dependencies
    const downloadLink = 'https://drive.google.com/uc?export=download&id=1HxytnhRnPCjdLyYhMXNOQIUJsz1z35FF';
